          ...
          fields: [
            {
              name: 'layout',
              type: 'blocks',
              blocks: [CallToAction, Content, MediaBlock, Archive, FormBlock, SignupCTABlock, TwoColumnTextImageBlock, ProfileWithImage, VideoEmbedWithHeading, PricingPlansGrid, SectionHeroWithBadge, ServiceCardGridBlock],
              required: true,
              admin: {
                initCollapsed: true,
              },
