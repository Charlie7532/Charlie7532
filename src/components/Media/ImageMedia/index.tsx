...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  if (!src && resource && typeof resource === 'object') {
    ...
    // Debug logging
    console.log('ImageMedia - Resource URL:', url)
    console.log('ImageMedia - getClientSideURL():', getClientSideURL())
    ...
    console.log('ImageMedia - Final src:', src)
    console.log('ImageMedia - isAbsoluteUrl:', isAbsoluteUrl)
  }
