...
const branding: Field = {
    ...
    fields: [
        ...
        {
            name: 'useCustomAdminLogo',
            type: 'checkbox',
            label: 'Use Different Logo in Admin',
            defaultValue: false,
        },
        {
            name: 'adminLogoMode',
            type: 'select',
            label: 'Admin Logo Configuration',
            required: true,
            defaultValue: 'simple',
            options: [
                {
                    label: 'Simple (One logo for all admin themes)',
                    value: 'simple',
                },
                {
                    label: 'Light/Dark (Different admin logos for light and dark themes)',
                    value: 'lightDark',
                },
            ],
            admin: {
                condition: (_, siblingData) => siblingData.useCustomAdminLogo === true,
            },
        },
        {
            name: 'adminLogo',
            ...
            label: 'Admin Logo',
            admin: {
                condition: (_, siblingData) => siblingData.useCustomAdminLogo === true && siblingData.adminLogoMode === 'simple',
            },
        },
        {
            type: 'row',
            fields: [
                {
                    ...
                    type: 'upload',
                    relationTo: 'media',
                    label: 'Admin Light Mode Logo',
                    admin: {
                        condition: (_, siblingData) => siblingData.useCustomAdminLogo === true && siblingData.adminLogoMode === 'lightDark',
                        width: '50%'
                    },
                },
                {
