...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data, siteSettings }) => {
  ...
  const getHeaderStyles = () => {
    const backgroundType = data?.settings?.backgroundType || 'transparent'
    const backgroundColor = data?.settings?.backgroundColor || '#ffffff'
    const textColor = data?.settings?.textColor || 'auto'
    const isSticky = data?.settings?.sticky || false
